...
export class App {
    ...
    attached() {
        ...
        this.dragAndDropController.containerGroups.containerGroup0.containers.container0.items.push({ id: "2", propertyA: "item2 propA (container0)", propertyB: 2 });
        this.dragAndDropController.containerGroups.containerGroup0.containers.container0.items.push({ id: "3", propertyA: "item3 propA (container0)", propertyB: 3 });

        this.dragAndDropController.containerGroups.containerGroup0.containers.container1.items.push({ id: "4", propertyA: "item4 propA (container1)", propertyB: 4 });
        this.dragAndDropController.containerGroups.containerGroup0.containers.container1.items.push({ id: "5", propertyA: "item5 propA (container1)", propertyB: 5 });

        this.dragAndDropController.containerGroups.containerGroup0.containers.container2.items.push({ id: "6", propertyA: "item6 propA (container2)", propertyB: 6 });
    ...
    click_test() {
        ...
        console.log(this.dragAndDropController.containerGroups.containerGroup0.containers.container1)
        console.log(this.dragAndDropController.containerGroups.containerGroup0.containers.container2)
    }
